...
The Packet Analyzer Platform provides an intuitive web interface for uploading packet captures, configuring firewall rules, monitoring network activity, and visualizing packet statistics generated by the native C++ Deep Packet Inspection engine.

---

## 🏠 Dashboard

The dashboard serves as the central overview of the platform, presenting key packet statistics, protocol distribution, detected applications, and overall network activity after a PCAP analysis.

<p align="center">
<img src="./pics/Dashboard.png" alt="Dashboard" width="100%">
</p>
...
The analytics page visualizes processed network traffic through interactive charts and summary cards, helping users understand protocol usage, traffic composition, and application distribution.

<p align="center">
<img src="./pics/Analytics.png" alt="Analytics" width="100%">
</p>
...
The firewall interface allows users to create, manage, and remove filtering rules based on IP addresses, domains, or detected applications. These rules are applied by the native DPI engine during packet analysis.

<p align="center">
<img src="./pics/Firewall.png" alt="Firewall" width="100%">
</p>
